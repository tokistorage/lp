    ...
    "ja": {
        ...
        "s3": {
            ...
            "cards": [
                ...
                ("03", "石英ガラスへの刻印",
                 "サーバー・電源・制度に依存しない、1000年耐久（理論値）の記録媒体。スマホカメラだけで読み取り可能。"),
                ("04", "継続的なキュレーション",
        ...
        "s6": {
            ...
            "items": [
                ...
                (GREEN_PALE, "R", "思想フレームワークレポート",
                 "あなたの存在証明を、100以上の思想エッセイの文脈に位置づけたレポート。「なぜ残すのか」の知的な裏付け。"),
            ],
            "footer": "Timeless Consulting",
        },
        "pricing": {
        ...
        "s7": {
            ...
            "bio": "大手コンサルティングファームでの経験を経て、半導体製造装置のエンジニアリング20年超。タイムレスタウン新浦安（250世帯）の自治会長として「ゆりかごから墓場まで」のコミュニティ運営を経験。SoulCarrier活動で「記憶が消える恐怖」を目の当たりにし、TokiStorageを着想。マウイ・山中湖でのオフグリッド実証を経て、制度に依存しない千年設計の技術を完成。100以上の思想エッセイを執筆し、9つの知的領域から存在証明の意味を探究し続けている。",
            "tags": ["元Big4ファーム", "半導体エンジニアリング 20年+", "自治会長（250世帯）",
                     "SoulCarrier主宰", "100+思想エッセイ執筆", "オフグリッド実証済み", "佐渡島に拠点設置予定",
        ...
        "s6": {
            ...
            "items": [
                ...
                (GREEN_PALE, "R", "Philosophical Framework Report",
                 "A report placing your proof of existence in the context of 100+ philosophical essays. Intellectual grounding for \"why preserve.\""),
            ],
            "footer": "Timeless Consulting",
        },
        "pricing": {
