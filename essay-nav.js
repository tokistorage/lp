...
(function() {
  const essays = [
    ...
    { id: 'custom-soap-guide', ja: 'カスタム形状ソープ', en: 'Custom-Shaped Soap', date: '2026-03-02' },
    ...
    { id: 'fire-music', ja: '消防音楽隊とトキストレージ', en: 'Fire Department Bands & TokiStorage', date: '2026-03-07' },
    ...
    { id: '404', ja: 'ページが見つかりません', en: 'ページが見つかりません' },
    { id: 'accessibility-policy', ja: 'ウェブアクセシビリティポリシー', en: 'Web Accessibility Policy' },
    { id: 'ambassador', ja: '認定アンバサダープログラム', en: 'Certified Ambassador Program' },
    { id: 'copyright', ja: '著作権・リンクポリシー', en: 'Copyright &amp; Link Policy' },
    { id: 'development-policy', ja: '開発ポリシーと免責事項', en: '開発ポリシーと免責事項' },
    { id: 'display-settings', ja: '文字サイズ・配色の変更', en: 'Display Settings' },
    { id: 'essay-template', ja: '{{TITLE_JA}}', en: '{{TITLE_EN}}' },
    { id: 'essays', ja: 'エッセイ一覧', en: 'Essays' },
    { id: 'founding-story', ja: '創業ストーリー', en: 'Founding Story' },
    { id: 'googlebedfb9e9cd13c298', ja: 'googlebedfb9e9cd13c298', en: 'googlebedfb9e9cd13c298' },
    { id: 'government-template-estimate', ja: '御見積書', en: '御見積書' },
    { id: 'government-template-overview', ja: '事業者概要書', en: '事業者概要書' },
    { id: 'government-template-proposal', ja: '企画提案書', en: '企画提案書' },
    { id: 'government-template-specification', ja: '業務仕様書', en: '業務仕様書' },
    { id: 'guide', ja: 'はじめての方へ', en: 'First-Time Visitors' },
    { id: 'harmony-fluctuation', ja: '調和の揺らぎ', en: '調和の揺らぎ' },
    ...
    { id: 'log', ja: 'LOG', en: 'LOG' },
    { id: 'ndl-publishing', ja: 'NDLニュースレター発行サービス', en: 'NDL Newsletter Publishing Service' },
    { id: 'offgrid', ja: 'オフグリッド構築支援コンサル', en: 'Off-Grid Setup Consulting' },
    { id: 'order-independence', ja: '順序独立性', en: 'Order Independence' },
    { id: 'requirements', ja: '動作環境・推奨環境', en: 'System Requirements' },
    { id: 'retainer', ja: 'タイムレスアドバイザー', en: 'Timeless Advisor' },
    { id: 'rss', ja: 'RSS購読ガイド', en: 'RSS Subscription Guide' },
    { id: 'sato-takuya-career', ja: '職務経歴書', en: '職務経歴書' },
    { id: 'sato-takuya-resume', ja: '履歴書', en: '履歴書' },
    { id: 'soap-refill', ja: '感想を伝える', en: 'Share Your Thoughts' },
    { id: 'soulcarrier', ja: 'SoulCarrier 共鳴の会', en: 'SoulCarrier Resonance Circle' },
    { id: 'tech-deck', ja: '技術アーキテクチャ', en: 'Technical Architecture' },
    { id: 'timelesstown', ja: 'タイムレスタウン新浦安の皆さまへ', en: 'To the Residents of Timeless Town Shin-Urayasu' },
    { id: 'unread-letters', ja: '読まれなくてもいい手紙', en: 'Letters That May Never Be Read' },
  ...
  // ── Essays List Link ──
  const essaysListLink = isEnglish
    ? '<a href="essays-en.html" style="font-size:0.85rem;">&larr; All Essays</a>'
    : '<a href="essays.html" style="font-size:0.85rem;">&larr; エッセイ一覧</a>';
